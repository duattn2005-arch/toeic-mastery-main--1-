...
export async function PartDetailView({ part, userId }: { part: TestPart; userId: string }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div data-tour={meta.skill === "LISTENING" ? "listening-tips" : undefined} className="rounded-2xl border border-border bg-card p-5 shadow-soft">
      ...
      {meta.skill === "LISTENING" && <ListeningPartTour />}
    </div>
  );
}
